$(document).ready(function(){
    ...
    $(btnUSA).on('click', function(e){
        ...
        /*************** SERVICES ***************/
        var services_div1_html = `<div id="services_div1" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-briefcase fa-3x icon-color"></i><span>BUSINESS ANALYTICS</span><p id="services_p1" class="separator">The main skill to become a problem solver is to understand the company's business, understanding the pains and needs of managers. This is my main objective and all my projects are oriented towards solving the business problem using analytical knowledge and technology tools as a means.</p></div></div>`;
        var services_div2_html = `<div id="services_div2" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-d fa-3x icon-color"></i><i class="fa-solid fa-pepper-hot fa-3x icon-color"></i><i class="fa-brands fa-docker fa-3x icon-color"></i><span>DJANGO, FLASK AND DOCKER</span><p id="services_p2" class="separator">Main Python frameworks for web application development. I have experience with a Freelance project using Flask and projects developed with Django. Docker is a platform that allows the creation of isolated virtual environments, widely used today.</p></div></div>`;
        var services_div3_html = `<div id="services_div3" class="swiper-slide"><div class="services-block"><i class="fab fa-python fa-3x icon-color"></i><i class="fas fa-c fa-3x icon-color"></i><span>PYTHON, C AND C++</span><p id="services_p3" class="separator">Advanced knowledge in Python with more than four years of experience with the language to solve the most varied subjects. With projects ranging from computer vision, website creation to projects involving big data, machine learning and data analysis. I have projects using C and C++ for projects that demand more computational performance.</p></div></div>`;
        var services_div4_html = `<div id="services_div4" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-database fa-3x icon-color"></i><span>PL/SQL</span><p id="services_p4" class="separator">More than two years of professional experience using SQL language to create procedures and views, advanced queries from different data sources, recording records generated by industrial machines and also for creating, changing and deleting tables and records.</p></div></div>`;
        var services_div5_html = `<div id="services_div5" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-cloud fa-3x icon-color"></i><i class="fa-brands fa-aws fa-3x icon-color"></i><span>CLOUD COMPUTING</span><p id="services_p5" class="separator">Experience with systems deployment in cloud environments using Azure. I have projects integrating Machine Learning models with Websites or model interaction via API consumption hosted in Cloud environments such as AWS, GCP and Azure.</p></div></div>`;
        var services_div6_html = `<div id="services_div6" class="swiper-slide"><div class="services-block"><i class="fas fa-feather-alt  fa-3x icon-color"></i><i class="far fa-star  fa-3x icon-color"></i><span>SPARK, HADOOP AND AWS BIG DATA</span><p id="services_p6" class="separator">Focused on improving my problem solving skills involving Big Data. For this, I have projects using Hadoop, Spark and the use of these technologies in Cloud environments, mainly AWS, with S3, SageMaker and EMR services.</p></div></div>`;
        var services_div7_html = `<div id="services_div7" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-chart-column fa-3x icon-color"></i><span>POWER BI AND TABLEAU</span><p id="services_p7" class="separator">The easiest way to convey the insights gained is through interactive dashboards. That's why I also specialize in tools and techniques that allow me to present the results in a simple, visual and easy-to-understand way for my audience.</p></div></div>`;
        var services_div8_html = `<div id="services_div8" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-screwdriver-wrench fa-3x icon-color"></i><span>OTHER TOOLS</span><p id="services_p8" class="separator">I have professional and academic experience with other tools and languages, such as: R, HTML 5, Css 3, JavaScript, .NET CORE, C#, Entity Framework and Java. And the use of Python for Back-end programming with Flask and Django.</p></div></div>`;
