$(document).ready(function(){
    ...
    $(btnUSA).on('click', function(e){
        ...
        var services_div8_html = `<div id="services_div8" class="swiper-slide"><div class="services-block"><i class="fa-solid fa-chart-column fa-3x icon-color"></i><span>OTHER TOOLS</span><p id="services_p8" class="separator">I have professional and academic experience with other tools and languages, such as: R, HTML 5, Css 3, JavaScript, .NET CORE, C#, Entity Framework and Java. And the use of Python for Back-end programming with Flask and Django.</p></div></div>`;
