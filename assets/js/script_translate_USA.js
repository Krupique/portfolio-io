$(document).ready(function(){
    ...
    $(btnUSA).on('click', function(e){
        ...
        var services_div4_html = `<div id="services_div4" class="swiper-slide"><div class="services-block"><i style="margin-right: 2%;"><img src="assets/img/icons/databricks_logo.png" width="19%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/snowflake_logo.png" width="21%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/apache_spark_logo.png" width="25%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/airflow_logo.png" width="17%"></i><span>DATA ENGINEERING TOOLS</span><p id="services_p2" class="separator">Two years of experience with data engineering tools for data ingestion, organization, and management of data flow using Airflow, Databricks, Snowflake and Spark.</p></div></div>`;
