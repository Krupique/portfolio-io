$(document).ready(function(){
    ...
    $(btnUSA).on('click', function(e){
        ...
        var services_div3_html = `<div id="services_div3" class="swiper-slide"><div class="services-block"><i style="margin-right: 2%;"><img src="assets/img/icons/aws_logo.png" width="24%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/aws_lambda_logo.jpg" width="20%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/aws_s3_logo.png" width="20%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/aws_ec2_logo.png" width="20%"></i><span>AMAZON WEB SERVICES</span><p id="services_p5" class="separator">One year of experience deploying machine learning models using AWS services.</p></div></div>`;
        var services_div4_html = `<div id="services_div4" class="swiper-slide"><div class="services-block"><i style="margin-right: 2%;"><img src="assets/img/icons/databricks_logo.png" width="21%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/snowflake_logo.png" width="23%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/apache_spark_logo.png" width="25%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/airflow_logo.png" width="18%"></i><span>DATA ENGINEERING TOOLS</span><p id="services_p2" class="separator">Two years of experience with data engineering tools for data ingestion, organization, and management of data flow using Airflow, Databricks, Snowflake and Spark.</p></div></div>`;
