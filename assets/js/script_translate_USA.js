$(document).ready(function(){
    ...
    $(btnUSA).on('click', function(e){
        ...
        /*************** SERVICES ***************/
        var services_div1_html = `<div id="services_div1" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/python_logo.png" width="20%"></i><i><img src="assets/img/icons/tensorflow_logo.png" width="20%"></i><i><img src="assets/img/icons/pytorch_logo.png" width="20%"></i><span>AI TOOLS AND FRAMEWORKS</span><p id="services_p3" class=" separator">Six years of experience with Python and building AI and Machine Learning models with Scikit Learn, Tensorflow, Pytorch, and others.</p></div></div>`;
        var services_div2_html = `<div id="services_div2" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/gcp_logo.png" width="25%"></i><i><img src="assets/img/icons/gcp_bigquery_logo.png" width="23%"></i><i><img src="assets/img/icons/gcp_cloud_ml_logo.jpg" width="23%"></i><i><img src="assets/img/icons/gcp_cloud_functions_logo.jpg" width="23%"></i><span>GOOGLE CLOUD COMPUTING</span><p id="services_p5" class="separator">Two years using GCP services such as BigQuery, Cloud Functions, Vertex AI, and Google Machine Learning to execute company projects.</p></div></div>`;
        var services_div3_html = `<div id="services_div3" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/aws_logo.png" width="24%"></i><i><img src="assets/img/icons/aws_lambda_logo.jpg" width="20%"></i><i><img src="assets/img/icons/aws_s3_logo.png" width="20%"></i><i><img src="assets/img/icons/aws_ec2_logo.png" width="20%"></i><span>AMAZON WEB SERVICES</span><p id="services_p5" class="separator">One year of experience deploying machine learning models using AWS services.</p></div></div>`;
        var services_div4_html = `<div id="services_div4" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/databricks_logo.png" width="22%"></i><i><img src="assets/img/icons/snowflake_logo.png" width="23%"></i><i><img src="assets/img/icons/apache_spark_logo.png" width="27%"></i><i><img src="assets/img/icons/airflow_logo.png" width="20%"></i><span>DATA ENGINEERING TOOLS</span><p id="services_p2" class="separator">Two years of experience with data engineering tools for data ingestion, organization, and management of data flow using Airflow, Databricks, Snowflake and Spark.</p></div></div>`;
        var services_div5_html = `<div id="services_div5" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/excel_logo.png" width="20%"></i><i><img src="assets/img/icons/power_bi.png" width="20%"></i><i><img src="assets/img/icons/looker_studio_logo.png" width="15%"></i><i><img src="assets/img/icons/tableau_logo.png" width="20%"></i><span>BUSINESS ANALYTICS</span><p id="services_p1" class="separator">Experience with analysis and visualization tools to communicate and present results to both technical and non-technical teams.</p></div></div>`;
        var services_div6_html = `<div id="services_div6" class="swiper-slide"><div class="services-block"><i><img src="assets/img/icons/rust_logo.png" width="20%"></i><i><img src="assets/img/icons/cpp_logo.png" width="20%"></i><i><img src="assets/img/icons/java_logo.png" width="18%"></i><span>OTHER LANGUAGES</span><p id="services_p5" class="separator">Extensive knowledge in other programming languages for various purposes, with a focus on performance, such as C, C++, Rust, and Java.</p></div></div>`;
        ...
        $('#resume_p5').text("Passionate about adventures on two wheels, fond of Chopin and playing it on the piano, bodybuilder and cook in the free time.");
