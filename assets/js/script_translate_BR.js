$(document).ready(function(){
    ...
    $(btnBR).on('click', function(e){
        ...
        var services_div4_html = `<div id="services_div4" class="swiper-slide"><div class="services-block"><i style="margin-right: 2%;"><img src="assets/img/icons/databricks_logo.png" width="21%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/snowflake_logo.png" width="23%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/apache_spark_logo.png" width="25%"></i><i style="margin-right: 2%;"><img src="assets/img/icons/airflow_logo.png" width="18%"></i><span>DATA ENGINEERING TOOLS</span><p id="services_p2" class="separator">Dois anos de experiência com ferramentas de engenharia de dados para ingestão, organização e gerenciamento do fluxo de dados utilizando Airflow, Databricks, Snowflake e Spark.</p></div></div>`;
